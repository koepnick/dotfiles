...
let s:N1 = [ '#00dfff' , s:guibg , 74  , s:termbg ]
let s:N2 = [ '#ff5f00' , s:guibg , 2  , s:termbg ]
let s:N3 = [ '#767676' , s:guibg , 15  , s:termbg ]
...
let s:I1 = [ '#5fff00' , s:guibg , 255  , s:termbg ]
let s:I2 = [ '#3399ff' , s:guibg , 2, s:termbg ]
let s:I3 = [ '#767676' , s:guibg , 15 , s:termbg ]
...
let g:airline#themes#serene#palette.insert_paste = {
      \ 'airline_a': [ s:I1[0]   , '#d78700' , s:I1[2] , 17     , ''     ] ,
      \ }

let g:airline#themes#serene#palette.replace = {
      \ 'airline_a': [ s:I1[0]   , '#af0000' , s:I1[2] , 52     , ''     ] ,
      \ }
...
let s:V2 = [ '#ff5f00' , s:guibg , 2 , s:termbg ]
let s:V3 = [ '#767676' , s:guibg , 15   , s:termbg ]
